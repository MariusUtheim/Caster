...
#define CASTER_NOT_INITIALIZED -1
...
extern "C"
{
	...
	EXPORT double caster_get_length(double handle, double method);
	EXPORT double caster_get_position(double handle, double method);
	EXPORT double caster_set_position(double handle, double value, double method);
#ifdef __cplusplus
}
#endif
